...
// tells Jest to replace the real implementation of this module with a mock
// snd arg is an arrow fn that return mockStore, 
// this fn is called to generate the mock implementation of the module
// => mockStore means that whenever the "../app/store" module is imported in the tests, it will be replaced with the mockStore object.
